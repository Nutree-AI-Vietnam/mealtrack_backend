...
| Cloudinary images | `src/infra/adapters/cloudinary_image_store.py` (user meal uploads) |
| Cloudflare Images | `src/infra/adapters/cloudflare_images_store.py` (catalog meal art) |
