...
def _profile(revision=1):
    return SimpleNamespace(
        ...
        body_fat_percentage=None, date_of_birth=None, target_weight_kg=None,
        goal_start_weight_kg=None, goal_started_at=None, job_type="desk",
        training_days_per_week=3, training_minutes_per_session=45,
        fitness_goal="recomp", meals_per_day=3, pain_points=[],
        dietary_preferences=[], training_level="beginner", referral_sources=[],
        challenge_duration=None, training_types=None, custom_protein_g=None,
        custom_carbs_g=None, custom_fat_g=None, profile_target_revision=revision,
    )
