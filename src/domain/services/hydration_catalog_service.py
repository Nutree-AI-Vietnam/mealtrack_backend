...
_DRINKS: list[Drink] = [
    ...
    Drink(
        ...
        name="Coconut",
        sub="Coconut water",
        # USDA FDC 174831 ready-to-drink unsweetened coconut water:
        # 18 kcal and 3.92 g total sugars per 100 g; 1 cup = 245 g.
        default_ml=245,
        kcal_per_100ml=18.0,
        sugar_per_100ml=3.92,
        hydration_weight=0.95,
        brand_color="#14B8A6",
        category=DrinkCategory.CALORIC,
    ),
...
_DRINK_TRANSLATIONS: dict[str, dict[str, dict[str, str | None]]] = {
    "vi": {
        ...
        "coconut": {"name": "Nước dừa", "sub": "Dừa tươi"},
    ...
    "es": {
        ...
        "coconut": {"name": "Coco", "sub": "Agua de coco"},
    ...
    "fr": {
        ...
        "coconut": {"name": "Coco", "sub": "Eau de coco"},
    ...
    "de": {
        ...
        "coconut": {"name": "Kokos", "sub": "Kokoswasser"},
    ...
    "ja": {
        ...
        "coconut": {"name": "ココナッツ", "sub": "ココナッツウォーター"},
