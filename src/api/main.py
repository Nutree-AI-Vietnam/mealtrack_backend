...
from src.api.routes.v1.meal_catalog_log import router as meal_catalog_log_router
...
from src.api.routes.v1.web_funnel_redemption_session import (
    router as web_funnel_session_router,
)
...
async def lifespan(app: FastAPI):
    ...
    from src.bootstrap.integration_services import drain_integration_event_publisher
    from src.infra.concurrency.executors import shutdown_firebase_executor
...
app.include_router(web_funnel_session_router)
