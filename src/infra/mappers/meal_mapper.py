...
def meal_orm_to_domain(orm: MealORM) -> DomainMeal:
    ...
    return DomainMeal(
        ...
        catalog_meal_content_hash=getattr(orm, "catalog_meal_content_hash", None),
        recipe_snapshot=getattr(orm, "recipe_snapshot", None),
        nutrition_snapshot=getattr(orm, "nutrition_snapshot", None),
...
def meal_domain_to_orm(domain: DomainMeal) -> MealORM:
    orm = MealORM(
        ...
        food_label_metadata=getattr(domain, "food_label_metadata", None),
        ...
        catalog_meal_id=getattr(domain, "catalog_meal_id", None),
        catalog_meal_content_hash=getattr(domain, "catalog_meal_content_hash", None),
        recipe_snapshot=getattr(domain, "recipe_snapshot", None),
        nutrition_snapshot=getattr(domain, "nutrition_snapshot", None),
